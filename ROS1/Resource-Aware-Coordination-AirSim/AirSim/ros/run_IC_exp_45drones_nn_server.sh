...
for algorithm in "${algorithms[@]}"; do
    ...
    for num_nearest_neighbors in "${num_nearest_neighbors_list[@]}"; do
        ...
        for random_seed in $(seq 1 30); do
            ...
            log_directory="${log_directory_base}/log_45drones_${random_seed}_${algorithm}_${num_nearest_neighbors}nn_100mbps"
            ...
            roslaunch image_covering_coordination image_covering_45drones_RAG.launch algorithm_to_run:=$algorithm random_seed:=$random_seed num_nearest_neighbors:=$num_nearest_neighbors is_server_experiment:=1 &
            sleep 2
