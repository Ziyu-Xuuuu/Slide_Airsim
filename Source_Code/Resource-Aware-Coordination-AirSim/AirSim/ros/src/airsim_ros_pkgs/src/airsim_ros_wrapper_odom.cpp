// Odom_local_ned ground truth pose published only for large-scale multi target tracking
...
void AirsimROSWrapper::create_ros_pubs_from_settings_json()
{
    ...
    {   
        ...
        // NOTE!!! Skipping cameras because we need odom only
        ...
        //             current_image_request_vec = {ImageRequest(curr_camera_name, msr::airlib::ImageCaptureBase::ImageType::Segmentation, false, false)} ;
